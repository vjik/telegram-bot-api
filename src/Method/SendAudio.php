 ...
 */
final readonly class SendAudio implements TelegramRequestWithResultPreparingInterface, TelegramRequestWithFilesInterface
{
    /**
    ...
    public function getData(): array
    {
        return array_filter(
            [
                ...
                'audio' => is_string($this->audio) ? $this->audio : null,
    ...
    public function getFiles(): array
    {
        return array_filter(
            [
                'audio' => $this->audio instanceof InputFile ? $this->audio : null,
